        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="auth.php" method="POST">
                    ...
                    <input type="submit" value="Log In" class="bg-red-500 text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8">
                </form>
                <div class="text-center pt-12 pb-12">
                    <p>Don't have an account? <a href="register.php" class="underline font-semibold text-red-400">Register here.</a></p>
                </div>
            </div>
