        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="">
                    ...
                    <input type="submit" value="Register" class="bg-red-500 text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8" />
                </form>
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <a href="login.php" class="underline font-semibold text-red-400">Log in here.</a></p>
                </div>
            </div>
