    ...
    <div class="max-w-xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-10">
        ...
        <form action="processAddMenu.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-end gap-10">
                <a href="adminMenu.php" class="px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                    Cancel
                </a>
                <a type="submit" class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                    Save Menu
                </a>
            </div>
        </form>
